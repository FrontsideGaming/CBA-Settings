...
// ACE Map Gestures
force ace_map_gestures_defaultColor = [0,1,1,0.8];
...
force ace_medical_maxReviveTime = 780;
...
force ace_medical_painCoefficient = 1.1;
...
force ace_finger_indicatorColor = [0.83,0.68,0.21,0];
force ace_finger_indicatorForSelf = false;
force ace_finger_maxRange = 0;
...
force adv_aceSplint_reopenChance_medic = 5;
...
force grad_trenches_functions_gigantEnvelopeDigTime = 100;
force grad_trenches_functions_shortEnvelopeDigTime = 30;
force grad_trenches_functions_smallEnvelopeDigTime = 40;
force grad_trenches_functions_stopBuildingAtFatigueMax = true;
force grad_trenches_functions_vehicleEnvelopeDigTime = 180;
